...
struct TORCH_API VariableType final : public at::TypeDefault {
  ...
  Tensor & btrisolve_out(Tensor & out, const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots) const override;
  ...
  Tensor & cross_out(Tensor & out, const Tensor & self, const Tensor & other, int64_t dim) const override;
