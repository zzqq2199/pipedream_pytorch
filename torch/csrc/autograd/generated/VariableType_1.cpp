...
Tensor VariableType::_adaptive_avg_pool2d(const Tensor & self, IntArrayRef output_size) const {
  profiler::RecordFunction profiler("_adaptive_avg_pool2d", Function::peek_at_next_sequence_nr());
...
Tensor VariableType::_cdist_backward(const Tensor & grad, const Tensor & x1, const Tensor & x2, double p, const Tensor & cdist) const {
  profiler::RecordFunction profiler("_cdist_backward", Function::peek_at_next_sequence_nr());
...
Tensor VariableType::_nnpack_spatial_convolution(const Tensor & input, const Tensor & weight, const Tensor & bias, IntArrayRef padding) const {
  profiler::RecordFunction profiler("_nnpack_spatial_convolution", Function::peek_at_next_sequence_nr());
  auto& input_ = unpack(input, "input", 0);
  auto& weight_ = unpack(weight, "weight", 1);
...
std::tuple<Tensor,Tensor> VariableType::_thnn_adaptive_max_pool2d_forward(const Tensor & self, IntArrayRef output_size) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_adaptive_max_pool2d_forward(self_, output_size);
  })();
...
Tensor VariableType::_thnn_adaptive_max_pool3d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & indices) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_thnn_adaptive_max_pool3d_backward(grad_output_, self_, indices_);
  })();
...
std::tuple<Tensor &,Tensor &> VariableType::_thnn_adaptive_max_pool3d_forward_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
...
std::tuple<Tensor,Tensor,Tensor,Tensor> VariableType::batch_norm_backward_reduce(const Tensor & grad_out, const Tensor & input, const Tensor & mean, const Tensor & invstd, bool input_g, bool weight_g, bool bias_g) const {
  profiler::RecordFunction profiler("batch_norm_backward_reduce", Function::peek_at_next_sequence_nr());
...
Tensor VariableType::btrisolve(const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->btrisolve(self_, LU_data_, LU_pivots_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::cartesian_prod(TensorList tensors) const {
  profiler::RecordFunction profiler("cartesian_prod", Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
...
Tensor VariableType::combinations(const Tensor & self, int64_t r, bool with_replacement) const {
  profiler::RecordFunction profiler("combinations", Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
...
std::tuple<Tensor,Tensor,double,int64_t> VariableType::fbgemm_linear_quantize_weight(const Tensor & input) const {
  profiler::RecordFunction profiler("fbgemm_linear_quantize_weight", Function::peek_at_next_sequence_nr());
  Tensor result0;
  Tensor result1;
  double result2;
  int64_t result3;
...
Tensor VariableType::hamming_window(int64_t window_length, const TensorOptions & options) const {
  profiler::RecordFunction profiler("hamming_window", Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
...
Tensor VariableType::logspace(Scalar start, Scalar end, int64_t steps, const TensorOptions & options) const {
  profiler::RecordFunction profiler("logspace", Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
  ...
  auto result = TypeDefault::logspace(start, end, steps, options);
  if (tracer_state) {
    jit::tracer::setTracingState(std::move(tracer_state));
    jit::tracer::addOutput(node, result);
  }
...
Tensor VariableType::miopen_depthwise_convolution_backward_weight(IntArrayRef weight_size, const Tensor & grad_output, const Tensor & self, IntArrayRef padding, IntArrayRef stride, IntArrayRef dilation, int64_t groups, bool benchmark, bool deterministic) const {
  profiler::RecordFunction profiler("miopen_depthwise_convolution_backward_weight", Function::peek_at_next_sequence_nr());
  auto& grad_output_ = unpack(grad_output, "grad_output", 1);
  auto& self_ = unpack(self, "self", 2);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( grad_output, self )) {
...
Tensor VariableType::native_clone(const Tensor & self) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->native_clone(self_);
  })();
  auto result = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor VariableType::quantized_gru_cell(const Tensor & input, const Tensor & hx, const Tensor & w_ih, const Tensor & w_hh, const Tensor & b_ih, const Tensor & b_hh, const Tensor & packed_ih, const Tensor & packed_hh, const Tensor & col_offsets_ih, const Tensor & col_offsets_hh, Scalar scale_ih, Scalar scale_hh, Scalar zero_point_ih, Scalar zero_point_hh) const {
  profiler::RecordFunction profiler("quantized_gru_cell", Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
...
Tensor VariableType::quantized_rnn_relu_cell(const Tensor & input, const Tensor & hx, const Tensor & w_ih, const Tensor & w_hh, const Tensor & b_ih, const Tensor & b_hh, const Tensor & packed_ih, const Tensor & packed_hh, const Tensor & col_offsets_ih, const Tensor & col_offsets_hh, Scalar scale_ih, Scalar scale_hh, Scalar zero_point_ih, Scalar zero_point_hh) const {
  profiler::RecordFunction profiler("quantized_rnn_relu_cell", Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
...
Tensor VariableType::rand(IntArrayRef size, const TensorOptions & options) const {
  profiler::RecordFunction profiler("rand", Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
...
Tensor VariableType::randn(IntArrayRef size, const TensorOptions & options) const {
  profiler::RecordFunction profiler("randn", Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
...
Tensor VariableType::sum_to_size(const Tensor & self, IntArrayRef size) const {
  profiler::RecordFunction profiler("sum_to_size", Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
